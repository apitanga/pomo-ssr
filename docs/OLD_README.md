...
This is the **application template** that works with the [terraform-aws-serverless-ssr](https://github.com/pomo-studio/terraform-aws-serverless-ssr) infrastructure.
...
See [terraform-aws-serverless-ssr](https://github.com/pomo-studio/terraform-aws-serverless-ssr) for infrastructure setup.
...
The app reads infrastructure configuration from `config/infra-outputs.json`. This file is generated by the [terraform-aws-serverless-ssr](https://github.com/pomo-studio/terraform-aws-serverless-ssr) and contains:
...
| Repository | Purpose |
|------------|---------|
| [terraform-aws-serverless-ssr](https://github.com/pomo-studio/terraform-aws-serverless-ssr) | Terraform module for AWS infrastructure |
| [serverless-ssr-pattern](https://github.com/pomo-studio/serverless-ssr-pattern) | Original project (archived/inspiration) |
